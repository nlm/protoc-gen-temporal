...
func Register{{$service.GoName}}Worker(w worker.Worker, wrk {{$service.GoName}}Worker) {
	{{range $method := .Methods}}
	w.RegisterWorkflowWithOptions(wrk.{{$method.GoName}}, workflow.RegisterOptions{Name: "{{$service.GoName}}.{{$method.GoName}}"})
	{{end}}
}
